...
\end{center}
The phase flag is now $0$ (walking) and the booking is done (step $1$). It is minute $139$ of the
$720$-minute day (time $0.19$). The three booked windows now show their clock times, minutes $160$,
$440$, $470$ ($0.22$, $0.61$, $0.65$ of the day) and the Botticelli check-in flag has flipped to $1$.
The access read lights up: this is a gated masterpiece ($1$), it is not unbooked ($0$), you may
appreciate it now ($1$) and your window opened a little earlier (a slightly negative time-to-open,
$-0.18$). The room tail is the punchline: importance $10$, the maximum (seen as $1.0$) and a room packed
to capacity ($1.0$), yet because you are inside your reserved window you collect the reward regardless of
the crush.
...
\end{center}
It is now minute $679$ of the $720$-minute day (time $0.94$), almost closing; all three check-in flags
read $1$: every masterpiece is done. The access read is back to all zeros, because Caravaggio is not a
gated room, you walk straight in; its importance is still high ($7.4$, seen as $0.74$) while it is only
$13\%$ full ($0.13$). The egress slack has fallen to $0.05$ ($\approx37$ minutes of spare time): the day
is nearly over, which is exactly why the agent is on the first floor heading out.
